...
def test_apply_bwb_etiqueta_normal_registers_stylesheet_and_alignment(qapp):
    ...
    expected_stylesheet = (
        f"{expected_selector} {{ font-size: 14pt; font-weight: 700; background-color: rgba(44, 54, 57, 0.80); "
        "border: 1px solid rgba(0, 0, 0, 1); color: rgba(255, 255, 255, 0.80); padding: 4px 6px; margin: 0px; }}"
    )
