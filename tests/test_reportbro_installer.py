...
def test_default_pip_args_outside_virtualenv(monkeypatch):
    monkeypatch.setattr(
        reportbro_installer,
    ...
    assert reportbro_installer.default_pip_args() == ("--user",)


def test_default_pip_args_inside_virtualenv(monkeypatch):
    monkeypatch.setattr(
        reportbro_installer,
        "running_inside_virtualenv",
        lambda: True,
...
def test_default_pip_args_when_user_site_disabled(monkeypatch):
    monkeypatch.setattr(
        reportbro_installer,
        "running_inside_virtualenv",
        lambda: False,
