...
class FTApp(QWidget):
    ...
    def _build_ui(self):
        ...
        self.mnuRoot.setFont(menu_font)
        mBD = QMenu("Base de Dados", self.mnuRoot)
        mBD.setFont(menu_font)
