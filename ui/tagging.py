...
_ZONE_TAGS: Mapping[str, str] = {
    ...
    "family_values_column": "B1.C1.A.2.A.1.B",
    "family_value_familia": "B1.C1.A.2.A.1.B.1",
    "family_value_subfamilia": "B1.C1.A.2.A.1.B.2",
    "family_combos_section": "B1.C1.A.2.B",
    "family_combo_col_1": "B1.C1.A.2.B.1",
    "family_combo_col_2": "B1.C1.A.2.B.2",
    "family_combo_col_3": "B1.C1.A.2.B.3",

    # --- PVPs -------------------------------------------------------------
    "pvps_root": "B1.C1.A.2.B.A",
    "pvps_grid": "B1.C1.A.2.B.A.1",
    "pvps_col_1": "B1.C1.A.2.B.A.1.1",
    "pvps_col_2": "B1.C1.A.2.B.A.1.2",
    "pvps_col_3": "B1.C1.A.2.B.A.1.3",
    "pvps_col_4": "B1.C1.A.2.B.A.1.4",
    "pvps_col_5": "B1.C1.A.2.B.A.1.5",
