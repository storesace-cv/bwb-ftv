...
| **tools/run_migration_preparacao.py** | Script CLI que aplica migrações de preparação e valida a tabela `ProdutoPreparacao`. | Referenciado em `docs/agent_resources.md`. | Migration Agent.
