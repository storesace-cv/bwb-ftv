...
### Added
- Documented that ReportBro template `ft_gestao_00_base.json` agora inclui uma tabela
...
### Added
- Introduced product image integration in ReportBro template `ft_gestao_00_base.json`.
