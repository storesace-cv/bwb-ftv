...
- **Blocks**: `B{n}` denote top-level blocks (e.g., `B1`, `B4`). O bloco `B1` agrega Dados
  Gerais, Família, Combos e os PVPs agora alojados em `B1.C1.A.2.A.*`. A antiga designação `B2`
