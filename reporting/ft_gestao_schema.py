...
FT_GESTAO_PARAMETER_DEFINITIONS: dict[str, ParameterDefinition] = {
    ...
    "FoodCost_Nivel1_Nivel": {
        "section": "precos_taxas",
        "field": "food_cost_nivel1_nivel",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel1_Cor": {
        "section": "precos_taxas",
        "field": "food_cost_nivel1_cor",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel2": {
    ...
    "FoodCost_Nivel2_Nivel": {
        "section": "precos_taxas",
        "field": "food_cost_nivel2_nivel",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel2_Cor": {
        "section": "precos_taxas",
        "field": "food_cost_nivel2_cor",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel3": {
    ...
    "FoodCost_Nivel3_Nivel": {
        "section": "precos_taxas",
        "field": "food_cost_nivel3_nivel",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel3_Cor": {
        "section": "precos_taxas",
        "field": "food_cost_nivel3_cor",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel4": {
    ...
    "FoodCost_Nivel4_Nivel": {
        "section": "precos_taxas",
        "field": "food_cost_nivel4_nivel",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel4_Cor": {
        "section": "precos_taxas",
        "field": "food_cost_nivel4_cor",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel5": {
    ...
    "FoodCost_Nivel5_Nivel": {
        "section": "precos_taxas",
        "field": "food_cost_nivel5_nivel",
        "type": "text",
        "optional": True,
    },
    "FoodCost_Nivel5_Cor": {
        "section": "precos_taxas",
        "field": "food_cost_nivel5_cor",
        "type": "text",
        "optional": True,
    },
    "PrecosTaxas_Iva1": {
